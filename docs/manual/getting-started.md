...
Open it from **Setup ▸ Plugins ▸ Add Plugin**.

![Setup ▸ Plugins, with Add Plugin opening the browser and Add Plugin from URL keeping the old prompt](../img/10-add-plugin-row.webp)
